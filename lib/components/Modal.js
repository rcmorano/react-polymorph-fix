...
var ModalBase = function (_Component) {
  _inherits(ModalBase, _Component);
  ...
  _createClass(ModalBase, [{
    ...
    value: function render() {
      ...
      var ModalSkin = skin || context.skins[_.IDENTIFIERS.MODAL];

      return _react2.default.createElement(ModalSkin, _extends({ theme: this.state.composedTheme }, rest));
    }
  }]);
...
ModalBase.defaultProps = {
  ...
  theme: null,
  themeId: _.IDENTIFIERS.MODAL,
  themeOverrides: {}
};
var Modal = exports.Modal = (0, _withTheme.withTheme)(ModalBase);
