...
var TooltipBase = function (_Component) {
  ...
  function TooltipBase(props) {
    ...
    var _this = _possibleConstructorReturn(this, (TooltipBase.__proto__ || Object.getPrototypeOf(TooltipBase)).call(this, props));
  ...
  _createClass(TooltipBase, [{
    ...
    value: function render() {
      ...
      var TooltipSkin = skin || context.skins[_.IDENTIFIERS.TOOLTIP];

      return _react2.default.createElement(TooltipSkin, _extends({ theme: this.state.composedTheme }, rest));
    }
  }]);
...
TooltipBase.defaultProps = {
  ...
  theme: null,
  themeId: _.IDENTIFIERS.TOOLTIP,
  themeOverrides: {}
};
var Tooltip = exports.Tooltip = (0, _withTheme.withTheme)(TooltipBase);
