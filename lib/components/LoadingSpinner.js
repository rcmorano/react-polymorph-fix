...
var LoadingSpinnerBase = function (_Component) {
  _inherits(LoadingSpinnerBase, _Component);

  // define static properties
  function LoadingSpinnerBase(props) {
    _classCallCheck(this, LoadingSpinnerBase);

    var _this = _possibleConstructorReturn(this, (LoadingSpinnerBase.__proto__ || Object.getPrototypeOf(LoadingSpinnerBase)).call(this, props));
  ...
  _createClass(LoadingSpinnerBase, [{
    ...
    value: function render() {
      ...
      var LoadingSpinnerSkin = skin || context.skins[_.IDENTIFIERS.LOADING_SPINNER];

      return _react2.default.createElement(LoadingSpinnerSkin, _extends({ theme: this.state.composedTheme }, rest));
    }
  }]);
...
LoadingSpinnerBase.defaultProps = {
  ...
  theme: null,
  themeId: _.IDENTIFIERS.LOADING_SPINNER,
  themeOverrides: {},
  visible: true
};
var LoadingSpinner = exports.LoadingSpinner = (0, _withTheme.withTheme)(LoadingSpinnerBase);
