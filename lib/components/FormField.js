...
var FormFieldBase = function (_Component) {
  _inherits(FormFieldBase, _Component);

  // define static properties
  function FormFieldBase(props) {
    _classCallCheck(this, FormFieldBase);

    var _this = _possibleConstructorReturn(this, (FormFieldBase.__proto__ || Object.getPrototypeOf(FormFieldBase)).call(this, props));
  ...
  _createClass(FormFieldBase, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          rest = _objectWithoutProperties(_props, ['skin', 'theme', 'themeOverrides', 'error', 'context', 'inputRef']);

      var FormFieldSkin = skin || context.skins[_.IDENTIFIERS.FORM_FIELD];

      return _react2.default.createElement(FormFieldSkin, _extends({
...
FormFieldBase.defaultProps = {
  ...
  theme: null,
  themeId: _.IDENTIFIERS.FORM_FIELD,
  themeOverrides: {}
};
var FormField = exports.FormField = (0, _withTheme.withTheme)(FormFieldBase);
